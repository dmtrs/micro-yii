...
class CComponentTest extends CTestCase
{
	...
	public function testGetProperty()
	{
		...
		try {
			...
			$this->assertInstanceOf('\Yii\Base\CException', $e);
	...
	{
		$this->component->attachEventHandler('OnMyEvent','foo');
		$this->assertInstanceOf('\Yii\Collections\CList', $this->component->getEventHandlers('onMyEvent'));
	...
	public function testRaiseEvent()
	{
		...
		$this->component->raiseEvent('OnMyEvent',new \Yii\Base\CEvent($this->component));
		$this->assertTrue($this->component->eventHandled);

		try {
			$this->component->raiseEvent('OnUnknown', new \Yii\Base\CEvent($this->component));
		} catch (Exception $e) {
			$this->assertInstanceOf('\Yii\Base\CException', $e);
